Contributing to BITRUBCOIN Core
============================

The BITRUBCOIN Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/bitrubcoin-project/bitrubcoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the BITRUBCOIN Core project, and is not to be
confused with overall BITRUBCOIN Network Protocol consensus changes.

Whether a pull request is merged into BITRUBCOIN Core rests with the project merge
...
Patches that change BITRUBCOIN consensus rules are considerably more involved than
...
Where a patchset proposes to change the BITRUBCOIN consensus, it must have been
...
The project leader is the release manager for each BITRUBCOIN Core release.
