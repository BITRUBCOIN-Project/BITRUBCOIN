BITRUBCOIN Core version v5.1.0 is now available from:  <https://github.com/bitrubcoin-project/bitrubcoin/releases>
...
- #2170 Better bitrubcoin.conf Masternode data error notification (furszy)
