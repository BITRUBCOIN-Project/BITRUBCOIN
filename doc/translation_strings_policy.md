...
This document provides guidelines for internationalization of the BITRUBCOIN Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitrubcoin_en.ts` remains unchanged.
