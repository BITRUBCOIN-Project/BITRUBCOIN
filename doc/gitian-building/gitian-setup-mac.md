...
The build script we'll be using is contained in the BITRUBCOIN github repository ([contrib/gitian-build.py](https://github.com/bitrubcoin-project/bitrubcoin/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the BITRUBCOIN repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/BITRUBCOIN-Project/BITRUBCOIN/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, bitrubcoin-detached-sigs, and bitrubcoin GitHub repos.
