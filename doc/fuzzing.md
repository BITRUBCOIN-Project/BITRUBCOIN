...
To build BITRUBCOIN Core using AFL instrumentation (this assumes that the
...
with certain assembly code from BITRUBCOIN Core's code. See [developer notes on sanitizers](https://github.com/BITRUBCOIN-Project/BITRUBCOIN/blob/master/doc/developer-notes.md#sanitizers)
