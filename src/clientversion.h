...
#error Client version information missing: version is not defined by bitrubcoin-config.h or in any other way
#endif
...
/**
 * bitrubcoind-res.rc includes this file, but it cannot cope with real c++ code.
