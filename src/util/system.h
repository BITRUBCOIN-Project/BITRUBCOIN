...
extern const char * const BITRUBCOIN_CONF_FILENAME;
extern const char * const BITRUBCOIN_PID_FILENAME;
extern const char * const BITRUBCOIN_MASTERNODE_CONF_FILENAME;
