 ...
 *  A CTxDestination is the internal data type encoded in a BITRUBCOIN address
 */
...
/**
 * Generate a BITRUBCOIN scriptPubKey for the given CTxDestination. Returns a P2PKH
