...
#ifndef BITRUBCOIN_SUPPORT_ALLOCATORS_POOLED_SECURE_H
#define BITRUBCOIN_SUPPORT_ALLOCATORS_POOLED_SECURE_H
...
#endif // BITRUBCOIN_SUPPORT_ALLOCATORS_POOLED_SECURE_H
