...
#ifndef BITRUBCOIN_WALLET_H
#define BITRUBCOIN_WALLET_H
...
enum WalletFeature {
    ...
    FEATURE_PRE_BITRUBCOIN = 61000, // inherited version..
...
public:
     ...
     * BITRUBCOIN: group coins by pair <CTxDestination, Optional<CTxDestination>>. The optional destination
    ...
    /// Get 10000 BRC output and keys which can be used for the Masternode
    ...
    bool CreateCoinstakeOuts(const CBrcStake& stakeInput, std::vector<CTxOut>& vout, CAmount nTotal) const;
