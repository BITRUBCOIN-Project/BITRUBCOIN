...
public:
    ...
    /**
     * Amount of bitrubcoin coming in to a transaction
...
// BITRUBCOIN: When check is false, this assumes that overwrites are never possible due to BIP34 always in effect
