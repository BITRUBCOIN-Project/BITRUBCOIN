...
BOOST_AUTO_TEST_CASE(test_Capitalize)
{
    ...
    BOOST_CHECK_EQUAL(Capitalize("bitrubcoin"), "BitRubCoin");
...
BOOST_AUTO_TEST_CASE(test_validateURL)
{
    ...
    BOOST_CHECK(validateURL("https://foo.bar/"));
    BOOST_CHECK(validateURL("http://bitrubcoin.foo.bar"));
    BOOST_CHECK(validateURL("https://foo.bar/bitrubcoin"));
    BOOST_CHECK(validateURL("https://foo.bar/bitrubcoin/more/"));
    BOOST_CHECK(validateURL("https://142.2.3.1"));
    BOOST_CHECK(validateURL("https://foo_bar.bitrubcoin.com"));
