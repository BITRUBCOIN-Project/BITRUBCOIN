...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help")) {
        ...
        std::string strUsage = PACKAGE_NAME " bitrubcoin-tx utility version " + FormatFullVersion() + "\n\n" +
                               "Usage:  bitrubcoin-tx [options] <hex-tx> [commands]  Update hex-encoded bitrubcoin transaction\n" +
                               "or:     bitrubcoin-tx [options] -create [commands]   Create hex-encoded bitrubcoin transaction\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitrubcoin transaction
