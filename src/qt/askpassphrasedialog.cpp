...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            BITRUBCOINGUI* window = static_cast<BITRUBCOINGUI*>(parentWidget());
...
{
    BITRUBCOINGUI* gui = static_cast<BITRUBCOINGUI*>(parentWidget());
...
{
    hide();
    static_cast<BITRUBCOINGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("Your wallet is now encrypted. "
               "Remember that encrypting your wallet cannot fully protect "
               "your BRCs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
