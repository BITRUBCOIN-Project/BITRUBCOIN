...
/** Utility functions used by the BITRUBCOIN Qt UI.
 */
namespace GUIUtil
{
...
// Render BITRUBCOIN addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZbrc = false);
QString formatBalanceWithoutHtml(CAmount amount, int nDisplayUnit = 0, bool isZbrc = false);
...
// Parse "bitrubcoin:" URI into recipient object, return true on successful parsing
