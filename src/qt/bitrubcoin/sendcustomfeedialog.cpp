...
#include "qt/bitrubcoin/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(BITRUBCOINGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &BITRUBCOINGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
