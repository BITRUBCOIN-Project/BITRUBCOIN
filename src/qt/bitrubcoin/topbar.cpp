...
#include "qt/bitrubcoin/topbar.h"
#include "qt/bitrubcoin/forms/ui_topbar.h"
#include "qt/bitrubcoin/lockunlock.h"
#include "qt/bitrubcoin/qtutils.h"
#include "qt/bitrubcoin/receivedialog.h"
#include "qt/bitrubcoin/loadingdialog.h"
#include "askpassphrasedialog.h"

#include "bitcoinunits.h"
#include "qt/bitrubcoin/balancebubble.h"
...
TopBar::TopBar(BITRUBCOINGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopBrc, ui->labelAmountTopShieldedBrc}, "amount-small-topbar");
    setCssProperty({ui->labelAmountBrc}, "amount-topbar");
    setCssProperty({ui->labelPendingBrc, ui->labelImmatureBrc}, "amount-small-topbar");
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("BITRUBCOIN")
    updateDisplayUnit();
...
void TopBar::updateBalances(const interfaces::WalletBalances& newBalance)
{
    ...
    // BRC Total
    QString totalBrc = GUIUtil::formatBalance(newBalance.balance, nDisplayUnit);
    ...
    // BRC
    // Top
    ui->labelAmountTopBrc->setText(totalTransparent);
    ui->labelAmountTopShieldedBrc->setText(totalShielded);
    // Expanded
    ui->labelAmountBrc->setText(totalBrc);
    ui->labelPendingBrc->setText(GUIUtil::formatBalance(newBalance.unconfirmed_balance + newBalance.unconfirmed_shielded_balance, nDisplayUnit));
    ui->labelImmatureBrc->setText(GUIUtil::formatBalance(newBalance.immature_balance, nDisplayUnit));
}
