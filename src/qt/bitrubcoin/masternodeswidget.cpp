...
#include "qt/bitrubcoin/forms/ui_masternodeswidget.h"

#include "qt/bitrubcoin/qtutils.h"
#include "qt/bitrubcoin/mnrow.h"
#include "qt/bitrubcoin/mninfodialog.h"
#include "qt/bitrubcoin/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(BITRUBCOINGUI *parent) :
    PWidget(parent),
...
void MasterNodesWidget::onCreateMNClicked()
{
    ...
    if (walletModel->getBalance() <= mnCollateralAmount) {
        inform(tr("Not enough balance to create a masternode, %1 required.")
            .arg(GUIUtil::formatBalance(mnCollateralAmount, BitcoinUnits::BRC)));
        return;
    }
    showHideOp(true);
