...
#include "qt/bitrubcoin/createproposaldialog.h"
#include "qt/bitrubcoin/forms/ui_createproposaldialog.h"

#include "qt/bitrubcoin/contactsdropdown.h"
...
CreateProposalDialog::CreateProposalDialog(BITRUBCOINGUI* parent, GovernanceModel* _govModel, WalletModel* _walletModel) :
    QDialog(parent),
...
void CreateProposalDialog::setupPageOne()
{
    ...
    setEditBoxStyle(ui->labelURL, ui->lineEditURL, "e.g https://forum.bitrubcoin/proposals/best_proposal_ever");
...
void CreateProposalDialog::setupPageTwo()
{
    ...
    setEditBoxStyle(ui->labelAmount, ui->lineEditAmount, "e.g 500 BRC");
...
void CreateProposalDialog::onAddrListClicked()
{
    ...
    if (!menuContacts) {
        ...
        menuContacts = new ContactsDropdown(
                width,
                height,
                dynamic_cast<BITRUBCOINGUI*>(parent()),
                this
        );
