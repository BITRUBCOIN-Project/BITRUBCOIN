...
#ifndef BITRUBCOIN_CORE_NEW_GUI_BITRUBCOINGUI_H
#define BITRUBCOIN_CORE_NEW_GUI_BITRUBCOINGUI_H
...
#include "qt/bitrubcoin/navmenuwidget.h"
#include "qt/bitrubcoin/topbar.h"
#include "qt/bitrubcoin/dashboardwidget.h"
#include "qt/bitrubcoin/send.h"
#include "qt/bitrubcoin/receivewidget.h"
#include "qt/bitrubcoin/addresseswidget.h"
#include "qt/bitrubcoin/coldstakingwidget.h"
#include "qt/bitrubcoin/governancewidget.h"
#include "qt/bitrubcoin/masternodeswidget.h"
#include "qt/bitrubcoin/snackbar.h"
#include "qt/bitrubcoin/settings/settingswidget.h"
...
/**
  BITRUBCOIN GUI main class. This class represents the main window of the BITRUBCOIN UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class BITRUBCOINGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit BITRUBCOINGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~BITRUBCOINGUI();
...
#endif //BITRUBCOIN_CORE_NEW_GUI_BITRUBCOINGUI_H
