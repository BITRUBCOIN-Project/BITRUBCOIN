...
#ifndef BITRUBCOIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define BITRUBCOIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //BITRUBCOIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
