...
#include "qt/bitrubcoin/forms/ui_masternodewizarddialog.h"
    ...
    mnModel(_mnModel)
{
    ...
    ui->labelMessage1a->setText(formatHtmlContent(
                formatParagraph(tr("To create a BITRUBCOIN Masternode you must dedicate %1 (the unit of BITRUBCOIN) "
