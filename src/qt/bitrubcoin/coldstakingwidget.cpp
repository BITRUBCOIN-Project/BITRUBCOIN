...
#include "qt/bitrubcoin/forms/ui_coldstakingwidget.h"
#include "qt/bitrubcoin/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/bitrubcoin/requestdialog.h"
...
ColdStakingWidget::ColdStakingWidget(BITRUBCOINGUI* parent) :
    PWidget(parent),
