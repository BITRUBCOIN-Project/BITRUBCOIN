...
#include "qt/bitrubcoin/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(BITRUBCOINGUI* _window, QWidget *parent) :
