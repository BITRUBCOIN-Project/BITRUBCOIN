...
#include <QWidget>
#include "qt/bitrubcoin/pwidget.h"
#include "qt/bitrubcoin/settings/settingsbackupwallet.h"
#include "qt/bitrubcoin/settings/settingsexportcsv.h"
#include "qt/bitrubcoin/settings/settingsbittoolwidget.h"
#include "qt/bitrubcoin/settings/settingssignmessagewidgets.h"
#include "qt/bitrubcoin/settings/settingswalletrepairwidget.h"
#include "qt/bitrubcoin/settings/settingswalletoptionswidget.h"
#include "qt/bitrubcoin/settings/settingsmainoptionswidget.h"
#include "qt/bitrubcoin/settings/settingsdisplayoptionswidget.h"
#include "qt/bitrubcoin/settings/settingsinformationwidget.h"
#include "qt/bitrubcoin/settings/settingsconsolewidget.h"
...
public:
    explicit SettingsWidget(BITRUBCOINGUI* parent);
    ~SettingsWidget();
