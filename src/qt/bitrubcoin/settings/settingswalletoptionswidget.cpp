...
#include "qt/bitrubcoin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/bitrubcoin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(BITRUBCOINGUI* _window, QWidget *parent) :
