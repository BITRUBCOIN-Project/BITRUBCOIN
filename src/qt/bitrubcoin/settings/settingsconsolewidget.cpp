...
#include "qt/bitrubcoin/settings/forms/ui_settingsconsolewidget.h"
...
SettingsConsoleWidget::SettingsConsoleWidget(BITRUBCOINGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    messageInternal(RPCExecutor::CMD_REPLY, (tr("Welcome to the BITRUBCOIN RPC console.") + "<br>" +
