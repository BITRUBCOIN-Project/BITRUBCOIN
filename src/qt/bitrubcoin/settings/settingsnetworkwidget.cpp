...
#include "qt/bitrubcoin/settings/settingsnetworkwidget.h"
#include "qt/bitrubcoin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/bitrubcoin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(BITRUBCOINGUI* _window, QWidget *parent) :
