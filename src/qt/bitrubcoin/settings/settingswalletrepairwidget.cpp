...
#include "qt/bitrubcoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/bitrubcoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(BITRUBCOINGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to BITRUBCOINGUI::handleRestart()
