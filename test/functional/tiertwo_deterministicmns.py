...
class DIP3Test(BitRubCoinTestFramework):
    ...
    def run_test(self):
        ...
        # Note: dmn2 sends (2 * 0.3 BRC) to the operator, and (2 * 2.7 BRC) to the owner
        ...
        assert_raises_rpc_error(-5, "invalid BITRUBCOIN address InvalidPayee",
        ...
        assert_raises_rpc_error(-5, "invalid BITRUBCOIN address InvalidPayee", controller.protx_update_registrar,
