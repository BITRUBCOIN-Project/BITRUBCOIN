...
class BlockIndexStatsTest(BitRubCoinTestFramework):
    ...
    def send_tx(self, node_from, node_to, fee, fFromShield, fToShield):
        if not fFromShield and not fToShield:
            ...
            # add 1 BRC "change" output 50% of the times
    ...
    def run_test(self):
        ...
        # miner creates 20 notes of 10 BRC + 9 notes of 5 BRC + 1 note of 4 BRC (using 1.0 fee)
