...
# Copyright (c) 2020-2021 The BITRUBCOIN developers
...
class FullBlockTest(BitRubCoinTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure bitrubcoind isn't accepting b26
        ...
        # Extend the b28 chain to make sure bitrubcoind isn't accepting b28
        ...
        # BITRUBCOIN: timestamp checks disabled for regtest
        ...
        #    Low-S and High-S values (whereas the bitrubcoin code has custom code which does so);
