...
class ListReceivedTest (BitRubCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 BRC.
        ...
        # Send 1 BRC to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 BRC sending them all (fee is 0.1 BRC)
        ...
        # Confirm transaction (2 BRC from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 BRC, send 0.6 BRC + 0.05 BRC fee
