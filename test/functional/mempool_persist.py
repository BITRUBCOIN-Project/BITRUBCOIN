...
By default, bitrubcoind will dump mempool on shutdown and
...
class MempoolPersistTest(BitRubCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent bitrubcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
