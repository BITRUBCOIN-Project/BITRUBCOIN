...
COIN = 100000000 # 1 BRC in satoshis
...
# Objects that map to bitrubcoind objects, which can be serialized/deserialized
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in bitrubcoind indicates these should be deserialized as blocks
