...
def append_config(dirname, n, options):
    datadir = get_datadir_path(dirname, n)
    with open(os.path.join(datadir, "bitrubcoin.conf"), 'a', encoding='utf8') as f:
...
def get_auth_cookie(datadir):
    user = None
    password = None
    if os.path.isfile(os.path.join(datadir, "bitrubcoin.conf")):
        with open(os.path.join(datadir, "bitrubcoin.conf"), 'r', encoding='utf8') as f:
            for line in f:
