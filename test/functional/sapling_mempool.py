#!/usr/bin/env python3
# Copyright (c) 2020 The BITRUBCOIN Core developers
...
class SaplingMempoolTest(BitRubCoinTestFramework):
    ...
    def run_test(self):
        ...
        # miner sends a 10 BRC note to Alice
        ...
        # miner sends another 10 BRC note to Alice
