...
class BITRUBCOIN_ColdStakingTest(BitRubCoinTestFramework):
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, self.mocktime, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 BRC from the pot)
...
if __name__ == '__main__':
    BITRUBCOIN_ColdStakingTest().main()
