...
EXPECTED_CIRCULAR_DEPENDENCIES=(
    ...
    "qt/bitrubcoin/bitrubcoingui -> qt/bitrubcoin/qtutils -> qt/bitrubcoin/bitrubcoingui"
    "qt/bitrubcoin/qtutils -> qt/bitrubcoin/snackbar -> qt/bitrubcoin/qtutils"
    "sapling/saplingscriptpubkeyman -> wallet/wallet -> sapling/saplingscriptpubkeyman"
    "spork -> sporkdb -> spork"
    "spork -> validation -> spork"
    "txmempool -> validation -> txmempool"
    "validation -> validationinterface -> validation"
    "validation -> zbrc/zbrcmodule -> validation"
